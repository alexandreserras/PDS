...
public class JGalo extends JFrame implements ActionListener {
	...
	public static void main(String args[]){
		...
		if (args.length == 1){
			if (args[0].equalsIgnoreCase("x") || args[0].equalsIgnoreCase("o")){
				playerIdentifier = args[0].charAt(0);
			}
		}
		else{
			playerIdentifier = 'x';
		}
		playerIdentifier=Character.toUpperCase(playerIdentifier);
		System.out.println(playerIdentifier);
		JGaloRules r1 = new JGaloRules(playerIdentifier);
		JGalo j1 = new JGalo(r1);
	}
} 
